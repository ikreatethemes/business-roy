jQuery(document).ready(function ($) {
    ...
    */
    ...
    function businessroy_sections_order(container) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {
                'action': 'businessroy_sections_reorder',
            ...
            $(container).find( '.businessroy-drag-spinner' ).hide();
            wp.customize.previewer.refresh();
        });
    }

    $('#sub-accordion-panel-businessroy_frontpage_settings').sortable({
        axis: 'y',
        helper: 'clone',
        cursor: 'move',
        items: '> li.control-section:not(#accordion-section-businessroy_slider_section)',
        delay: 150,
        update: function (event, ui) {
            $('#sub-accordion-panel-businessroy_frontpage_settings').find( '.businessroy-drag-spinner' ).show();
            businessroy_sections_order('#sub-accordion-panel-businessroy_frontpage_settings');
    ...
    //Scroll to section
    $('body').on('click', '#sub-accordion-panel-businessroy_frontpage_settings .control-subsection .accordion-section-title', function(event) {
        var section_id = $(this).parent('.control-subsection').attr('id');
        Businessroy_scrollToSection( section_id );
    });
...
function Businessroy_scrollToSection( section_id ){
    ...
    switch ( section_id ) {
        ...
        case 'sub-accordion-section-businessroy_slider_section':
        preview_section_id = "banner-slider";
        break;

        case 'accordion-section-businessroy_promoservice_section':
        preview_section_id = "businessroyfeature";
        break;

        case 'accordion-section-businessroy_aboutus_section':
        preview_section_id = "about_us_front";
        break;

        case 'accordion-section-businessroy_video_calltoaction_section':
        preview_section_id = "calltoactionvideo_promo_wrapper";
        break;

        case 'accordion-section-businessroy_service_section':
        preview_section_id = "businessroyservices";
        break;

        case 'accordion-section-businessroy_calltoaction_section':
        preview_section_id = "calltoaction_promo_wrapper";
        break;

        case 'accordion-section-businessroy_recentwork_section':
        preview_section_id = "businessroyportfolio";
        break;

        case 'accordion-section-businessroy_counter_section':
        preview_section_id = "businessroycounter_wrap";
        break;

        case 'accordion-section-businessroy_blog_section':
        preview_section_id = "businessroyblog";
        break;

        case 'accordion-section-businessroy_testimonial_section':
        preview_section_id = "businessroytestimonial";
        break;

        case 'accordion-section-businessroy_team_section':
        preview_section_id = "businessroyteam";
        break;
