...
$post_sidebar =  esc_attr( get_theme_mod( 'businessroy_blog_sidebar','right' ) );
				...
				<div class="articlesListing">	
					...
					?>	
							...
							<div class="prevNextArticle box">
								<div class="row">
									<div class="col-sm-6">
										<?php previous_post_link( '%link', '<div class="hoverExtend active"></div><div class="title">%title</div>' ); ?>
									</div>
									<div class="col-sm-6">
										<?php next_post_link( '%link', '<div class="hoverExtend active"></div><div class="title">%title</div>' ); ?>
									</div>
								</div>
